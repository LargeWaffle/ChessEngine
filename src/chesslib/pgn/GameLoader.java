...
package chesslib.pgn;

import static chesslib.pgn.PgnProperty.UTF8_BOM;
import static chesslib.pgn.PgnProperty.isProperty;
import static chesslib.pgn.PgnProperty.parsePgnProperty;

import java.util.HashMap;
import java.util.Iterator;
import java.util.UUID;

import chesslib.game.Event;
import chesslib.game.Game;
import chesslib.game.GameFactory;
import chesslib.game.GameResult;
import chesslib.game.Player;
import chesslib.game.PlayerType;
import chesslib.game.Round;
import chesslib.game.Termination;
import chesslib.game.TimeControl;
import chesslib.util.StringUtil;
